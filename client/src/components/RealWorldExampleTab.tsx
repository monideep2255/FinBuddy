    ...
    <div className="py-6 font-serif w-full">
      ...
      <div className="mt-8 p-4 bg-primary-50 dark:bg-primary-950 rounded-lg border border-primary-100 dark:border-primary-900">
        <div className="flex flex-col sm:flex-row items-start">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-primary-600 dark:text-primary-400 mr-3 mb-2 sm:mb-0 sm:mt-1 flex-shrink-0">
