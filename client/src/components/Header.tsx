    ...
    <header className="bg-white dark:bg-neutral-900 shadow-sm">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link href="/">
            <a className="font-medium text-primary-600 dark:text-primary-400 flex items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button className="md:hidden text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200 p-2">
