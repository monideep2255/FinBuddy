    ...
    <header className="bg-white dark:bg-neutral-900 shadow-sm relative z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6 flex-grow justify-center">
          <Link href="/">
            <div className="font-medium text-neutral-800 dark:text-neutral-100 flex items-center cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
