...
export default function ExplanationTab({ explanation, title }: ExplanationTabProps) {
  ...
  return (
    <div className="py-6 font-serif w-full">
      ...
      <div className="prose dark:prose-invert max-w-none w-full text-neutral-700 dark:text-neutral-300">
        {paragraphs}
      </div>
      
      <div className="flex flex-col sm:flex-row sm:items-center mt-8 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-neutral-500 dark:text-neutral-400 mr-3 mb-2 sm:mb-0">
